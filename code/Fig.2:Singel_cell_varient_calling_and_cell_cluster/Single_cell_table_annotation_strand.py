...
def gene_annotation_file_read(annotation_file,result_file):
	"""
	...
	for str_x in f:
		...
		if list_x[0] == "chrom":
			...
			d.write("\t".join([str_x,"editing_type","exon@intron","single@double"])+"\n")
			continue
...
def main():
	...
	gene_annotation_file_read(annotation_file,result_file)
