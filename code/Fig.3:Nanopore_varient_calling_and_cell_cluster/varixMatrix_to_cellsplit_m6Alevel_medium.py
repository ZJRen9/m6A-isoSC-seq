...
def matrix2dict(filename1,filename2,cellid2celltype_dict,output_medium_table):
	f1 = open(filename1,'r')
	f2 = open(filename2,'r')
	d1 = open(output_medium_table,'a')
	...
	for str_x_1 in f1:
		...
		try:
			...
			tmp_level_list_1 = celltype2value_dict["HEK293T"]
			tmp_level_list_1.sort()
			med_value_1 = tmp_level_list_1[len(tmp_level_list_1)//2]
		except:
			sum_value_1 = 0
			len_value_1 = 0
			med_value_1 = 0
		...
		try:	
			...
			tmp_level_list_2 = celltype2value_dict["Hela"]
			tmp_level_list_2.sort()
			med_value_2 = tmp_level_list_2[len(tmp_level_list_2)//2]
		except:
			sum_value_2 = 0
			len_value_2 = 0
			med_value_2 = 0
		...
		try:
			...
			tmp_level_list_3 = celltype2value_dict["HepG2"]
			tmp_level_list_3.sort()
			med_value_3 = tmp_level_list_3[len(tmp_level_list_3)//2]
		except:
			sum_value_3 = 0
			len_value_3 = 0
			med_value_3 = 0
		...
		#len_value_2 = len(celltype2value_dict["Hela"])
		#len_value_3 = len(celltype2value_dict["HepG2"])
		str2write = "\t".join([snpid,str(med_value_1),str(med_value_2),str(med_value_3),str(len_value_1),str(len_value_2),str(len_value_3)]) + "\n"
		d1.write(str2write)
...
def make_args():
	...
	parser.add_argument('--output_medium_table', required=True, help="output medium table")
...
def main():
	...
	output_medium_table = args.output_medium_table
	########################
	cellid2celltype_dict = celltype2dict(filename=celltype_filename)
	matrix2dict(filename1=matrix_filename_1,filename2=matrix_filename_2,cellid2celltype_dict=cellid2celltype_dict,output_medium_table=output_medium_table)
