...
def make_args():
	...
	parser.add_argument('--bed_format_file', required=True, help="C to U mutation bed format file")
	parser.add_argument('--GenePred_file', required=True, help="GenePred file")
	parser.add_argument('--EJD_annotated_file', required=True, help="EJD annotated file")
...
def main():
	...
	peak_format_file = args.bed_format_file
	transcript_file = args.GenePred_file
